...
from tokenization.analysis.analyze_latent_pose_info import load_net, get_codebook, _is_cosine
from tokenization.analysis.analyze_token_stability import load_pose_set
from tokenization.analysis.analyze_codebook_geometry import encode_shared, DEV, HERE, STAB, OUTDIR, NUM_POSES, SEED
...
def main():
    ...
    for i, label in enumerate(LABELS):
        ckpt = runs[label]
        ckpt = ckpt  # load_net resolves relative registry paths
