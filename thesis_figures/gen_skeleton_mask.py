...
sys.path.insert(0, os.path.join(TOKENHMR, "tokenization"))
from utils.skeleton import build_skeleton_attention_mask    # noqa: E402

MODEL_PATH = os.path.join(TOKENHMR, "data", "body_models")
MESH_PNG = os.path.join(REPO, "thesis", "images", "tokenizer", "skeleton_mesh.png")
